...
- (void)pathMenuItemTouchesBegin:(PathMenuItem * _Nonnull)item;
- (void)pathMenuItemTouchesEnd:(PathMenuItem * _Nonnull)item;
- (void)handleTap;
- (void)expand;
- (void)close;
- (void)setMenu;
...
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithImage:(UIImage * _Nonnull)image highlightedImage:(UIImage * _Nullable)himg contentImage:(UIImage * _Nullable)cimg highlightedContentImage:(UIImage * _Nullable)hcimg;
- (void)layoutSubviews;
- (void)touchesBegan:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
